        ...
        <ul class="navbar-nav h-100" id="navbar-nav">
            ...
            <template v-if="$page.props.roles.includes('Administrator')">
                ...
                <li class="nav-item">
                    ...
                    :class="{'active': $page.component.startsWith('Executive/Services') }">
                    <i class="ri-price-tag-3-fill"></i>
                    <span class="fw-semibold fs-14" data-key="t-dashboards">Services Management</span>
                    </Link>
                </li>
                 <li class="nav-item">
                    <Link href="/branches" class="nav-link menu-link"
                    :class="{'active': $page.component.startsWith('Executive/Branches') }">
                    <i class="ri-store-2-fill"></i>
                    <span class="fw-semibold fs-14" data-key="t-dashboards">Branches Management</span>
                    </Link>
                </li>
                <li class="nav-item">
