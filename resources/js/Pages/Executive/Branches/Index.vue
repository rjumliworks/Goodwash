<template>
<Head title="Branches"/>
<PageHeader title="Branch Management" pageTitle="List" />
    <BRow>
        <div class="col-md-12">
                ...
                <div class="card-header bg-light-subtle">
                    <div class="d-flex mb-n3">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="mb-0 fs-14"><span class="text-body">List of Branches</span></h5>
                        ...
                        <div class="flex-grow-1">
                            <ul class="nav nav-tabs nav-tabs-custom nav-primary fs-12" role="tablist">
                                <li class="nav-item">
                                    ...
                                    <i class="ri-apps-2-line me-1 align-bottom"></i> All Branches
                                    </BLink>
                                </li>
                                ...
                                <tr v-for="(list,index) in lists" v-bind:key="index" @click="selectRow(index)"
                                 :class="filter.status === null ? {
                                    ...
                                    <td>
                                        ...
                                        <p class="fs-12 text-muted mb-0">{{ list.barangay.name }}, {{ list.municipality.name }}, {{ list.province.name }}, {{ list.region.region}}</p>
                                    </td>
