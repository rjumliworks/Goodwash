                            ...
                            <div class="card-header bg-primary">
                                <div class="d-flex mb-n2">
                                    <div class="flex-shrink-0 me-3">
                                        ...
                                        <img src="@assets/images/job.png" alt="" class="avatar-sm">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <h5 class="mb-0 mt-2 fs-14"><span class="text-white fw-semibold text-uppercase fs-13">Goodwash</span></h5>
                                        <p class="text-white fs-11">Booking Management System</p>
                                    </div>
                                </div>
                            </div>
